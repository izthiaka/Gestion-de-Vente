    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body wigdet-two-content">
                                <p class="m-0 text-uppercase text-white" title="Statistics">CLIENT</p>
            ...
            <div class="col-xl-6 col-md-12">
                <div class="card widget-box-two bg-info">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body wigdet-two-content">
                                <p class="m-0 text-white text-uppercase" title="User Today">VENTE</p>
                                <h2 class="text-white"><span data-plugin="counterup">0</span></h2>
                            </div>
                            <div class="avatar-lg rounded-circle bg-soft-light ml-2 align-self-center">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-3">Mes Ventes Recentes </h4>
